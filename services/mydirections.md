...
```
https://maps.googleapis.com/maps/api/directions/json?origin=place_id:ChIJq6p6ZumM1YkRwlenRs5y5SY&destination=place_id:ChIJiSMgTuWN1YkR3cdzmZVHbro&key=AIzaSyCM-WWHYHIKY-do4kquMy9Z4wQaQx51AuE
```
